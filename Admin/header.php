                     ...
                     <div class="top-menu d-flex align-items-center">
                        ...
                        <div class="dropdown">
                            <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img class="avatar" src="img/portfolio-1.jpg"
                                    alt=""></a>
            ...
            <div class="app-sidebar colored">
                <div class="sidebar-header">
                    <a class="header-brand" href="index.html">
                        ...
                        <span class="text">Globsl Stay Hub</span>
                    </a>
                    ...
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item active">
                                <a href="adminindex.php"><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>
                            </div>
                            
                            
                            <div class="nav-lavel">UI Element</div>
                            <div class="nav-item has-sub">
                                <a href="#"><i class="ik ik-gitlab"></i><span>Registrations</span> <span
                                        class="badge badge-success">New</span></a>
                                <div class="submenu-content">
                                    <a href="country.php" class="menu-item">Country Registration</a>
                                    <a href="location.php" class="menu-item">Location Registration</a>
                                    <!-- <a href="district.php" class="menu-item">District Registration</a> -->
                                    <a href="city.php" class="menu-item">City Registration</a>
                                    <a href="university.php" class="menu-item">University Registration</a>
                                </div>
                            </div>


                            <div class="nav-item has-sub">
                                <a href="#"><i class="ik ik-box"></i><span>Browse Details</span></a>
                                <div class="submenu-content">
                                    <a href="countryview.php" class="menu-item">Country</a>
                                    <a href="locationview.php" class="menu-item">Locations</a>
                                    <!-- <a href="districtview.php" class="menu-item">Districts</a> -->
                                    <a href="cityview.php" class="menu-item">Cities</a>
                                    <a href="universityview.php" class="menu-item">Universities</a>
                                    
                                </div>
                            </div>
                            <div class="nav-item">
                                <a href="houseownerview.php"><i class="ik ik-award"></i><span>House Owners List</span></a>
                            </div>

                            <div class="nav-item">
                                <a href="piechart.php"><i class="ik ik-pie-chart"></i>Pie Charts</a>
                                 <!-- <div class="submenu-content">
                                    <a href="pages/ui/session-timeout.html" class="menu-item">Session Timeout</a>
                                </div> 
                            </div> -->
                            <div class="nav-item">
                                <a href="barchart.php"><i class="ik ik-bar-chart"></i><span>Bar Chart</span></a>
                            </div>
