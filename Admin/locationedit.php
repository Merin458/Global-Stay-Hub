...
<div class="center-container">
    <div class="card">
        <div class="card-body">
            ...
            <form action="locationeditaction.php" method="post" class="forms-sample" enctype="multipart/form-data">
                
                <div class="form-group">
                    <label for="exampleInputName1"> Edit Your Name</label>
                    <input type="text" name="locationname" class="form-control" id="exampleInputName1" placeholder="Name" value="<?php echo $display["location_name"];?>">
