...
<div class="center-container">
    <div class="card">
        <div class="card-body">
            ...
            <form action="categoryaction.php" method="post" class="forms-sample" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="category_description" id="exampleTextarea1" rows="4" placeholder="Enter category description"></textarea>
                </div>
                <div class="form-group">
